...
int main()
{
	...
	static std::uniform_int_distribution<int_least64_t> y;
	static std::uniform_int_distribution<uint_least16_t> m{ 0, 12 };
	static std::uniform_int_distribution<uint_least16_t> d{ 0, 31 };
	static std::uniform_int_distribution<uint_least16_t> h{ 0, 24 };
	static std::uniform_int_distribution<uint_least16_t> s{ 0, 60 };

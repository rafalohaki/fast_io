...
{
public:
	ssl_context(ossl_lib_context_observer ocob,cstring_view view,tls_method m):ssl_context_observer(SSL_CTX_new_with_libctx(ocob.native_handle(),view.data(),details::get_method(m)))
	{

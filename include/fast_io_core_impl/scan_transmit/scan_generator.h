...
struct scan_iterator
{
	...
	input *ptr;
	[[no_unique_address]] std::conditional_t<contiguous_buffer_input_stream<input>,details::empty,internal_temporary_buffer<typename input::char_type>*> pbuffer;
...
{
	input *ptr;
	[[no_unique_address]] std::conditional_t<contiguous_buffer_input_stream<input>,details::empty,internal_temporary_buffer<typename input::char_type>> buffer;
...
inline constexpr scan_generator<input,scan_line_seperator<typename input::char_type,u8'\n'>> line_generator(input& in)
{

...
*/
	return (get_nt_module_handle<std::uint32_t __stdcall(void** __restrict,std::uint32_t,object_attributes* __restrict,
		std::uint64_t*,std::uint32_t,std::uint32_t,void* __restrict) noexcept>("NtCreateSection"))(std::forward<Args>(args)...);
}
...
*/
	return (get_nt_module_handle<std::uint32_t __stdcall(void* __restrict,
		...
		std::uint32_t,std::uint32_t*) noexcept>("NtQueryInformationProcess"))(std::forward<Args>(args)...);
}
...
*/
	return (get_nt_module_handle<std::uint32_t __stdcall(void** __restrict,std::uint32_t,object_attributes*,
		void* __restrict,client_id* __restrict,void* __restrict,void* __restrict,int) noexcept>("NtCreateThread"))(std::forward<Args>(args)...);
}

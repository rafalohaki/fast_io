...
public:
	...
	posix_directory_file(cstring_view filename):posix_directory_file(posix_file(filename,open_mode::in|open_mode::directory))
	{
/*
...
*/
	...
	posix_directory_file(posix_at_entry pate,cstring_view filename):posix_directory_file(posix_file(pate,filename,open_mode::in|open_mode::directory))
	{
	}

...
../../include/fast_io_core_impl/print_scan.h:561:32:   required from 'constexpr void fast_io::println(output&&, Args&& ...) [with output = fast_io::basic_c_io_observer_unlocked<char>&; Args = {gooo&}]'
../../include/fast_io_core_impl/print_scan.h:515:10:   required from 'constexpr void fast_io::println(output&&, Args&& ...) [with output = fast_io::basic_c_io_observer<char>; Args = {gooo&}]'
...
../../include/fast_io_core_impl/print_scan.h:454:18: error: static assertion failed:
  ...
  454 |    static_assert(!buffer_output_stream<internal_buffer_type>,
      |                  ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*/